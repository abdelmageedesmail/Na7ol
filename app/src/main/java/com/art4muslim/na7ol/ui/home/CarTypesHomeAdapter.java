...
public class CarTypesHomeAdapter extends RecyclerView.Adapter<CarTypesHomeAdapter.MyHolder> {
    Context context;
    ...
    public CarTypesHomeAdapter(@NonNull Context context, List<CarTypeResponse.ReturnsEntity> list, String carType) {
